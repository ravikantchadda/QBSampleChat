    ...
    if ([cell conformsToProtocol:@protocol(QMChatAttachmentCell)]) {
        ...
        if (message.attachments != nil) {
            ...
            if ([attachment.type isEqualToString:@"video"]) {
                ...
                [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%d",indexPath.row] forKey:@"tag"];
            }else{
                [[NSUserDefaults standardUserDefaults]setBool:NO forKey:@"video"];
                [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%d",indexPath.row] forKey:@"tag"];
            }
...
//            }
            ...
            NSString *videopath = [basePath stringByAppendingPathComponent:imageName];

            CustomMoviePlayerViewController *moviePlayer = [[CustomMoviePlayerViewController alloc] initWithPath:videopath];
